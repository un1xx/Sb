...
import io
ownerid = [407135783678640128, 341958485724102668]
...
class REPL():
    ...
    async def repl(self, ctx):
        ...
        while True:
            response = await self.bot.wait_for('message', check=(lambda m: m.content.startswith('`') and m.author.id not in ownerid and m.channel==ctx.channel))
